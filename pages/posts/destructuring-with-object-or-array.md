...
Since we don't need to rename the same thing twice for getter and setter like React does, in [VueUse](https://github.com/Sunny-117/vueuse), I implemented most of the functions with object returns, like:
