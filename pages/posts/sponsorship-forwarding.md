...
lang: en
duration: 10min
description: An initiative to support open-source ecosystem by Sunny-117.
---
...
## Sunny-117's Collective

So, I came up with the idea of creating my personal collective: {Sunny-117 Collective}
...
- {Sponsor Sunny-117 on Open Collective|https://opencollective.com/antfu} - To sponsor the dependencies and ecosystem of the projects Anthony maintains.
- {Sponsor Sunny-117 on GitHub Sponsors|https://github.com/sponsors/antfu} - To sponsor Anthony's personal work on open-source projects.
