...
Simple, but surprisingly, it works really well. This is used for my [Browse Lite](https://github.com/Sunny-117/vscode-browse-lite) extension to inject the preferred color schema matching with VS Code's theme. And also [Iconify IntelliSense for VS Code](https://github.com/Sunny-117/vscode-iconify) to update icons color with the theme.
