...
projects:
  ...
  Nuxt Ecosystem:
    ...
    - name: 'Nuxt Server Functions'
      link: 'https://github.com/Sunny-117/nuxt-server-fn'
  ...
  DevTools:
    ...
    - name: 'Node Modules Inspector'
      link: 'https://github.com/Sunny-117/node-modules-inspector'
    ...
    - name: 'vite-plugin-inspect'
      link: 'https://github.com/Sunny-117/vite-plugin-inspect'
  ...
  Vite Ecosystem:
    ...
    - name: 'vite-plugin-pwa'
      ...
      icon: 'i-ion-logo-pwa'
    - name: 'vite-ssg'
      link: 'https://github.com/Sunny-117/vite-ssg'
      desc: 'Server-side generation for Vite'
      icon: 'i-carbon-printer'
    - name: 'vite-plugin-optimize-persist'
      link: 'https://github.com/Sunny-117/vite-plugin-optimize-persist'
  ...
  Vue Ecosystem:
    ...
    - name: 'vue-template-promise'
      link: 'https://github.com/Sunny-117/vue-template-promise'
      desc: 'Template as Promise in Vue'
      icon: 'i-carbon-cics-region-routing'
    - name: 'Vue Starport'
      link: 'https://github.com/Sunny-117/vue-starport'
    ...
    - name: 'Vue Reactivity'
      ...
      icon: 'vue-reactivity'
    - name: 'ReactiVue'
      link: 'https://github.com/Sunny-117/reactivue'
    ...
    - name: 'v-dollar'
      link: 'https://github.com/Sunny-117/v-dollar'
  ...
  Unplugins:
    ...
    - name: 'unplugin-vue-components'
      link: 'https://github.com/Sunny-117/unplugin-vue-components'
  ...
  ESLint Ecosystem:
    - name: 'eslint-config'
      link: 'https://github.com/Sunny-117/eslint-config'
    ...
    - name: 'eslint-typegen'
      link: 'https://github.com/Sunny-117/eslint-typegen'
    ...
    - name: 'eslint-flat-config-utils'
      link: 'https://github.com/Sunny-117/eslint-flat-config-utils'
      desc: 'Utilities for ESLint Flat Config'
      icon: 'i-carbon-tools-alt'
    - name: 'eslint-config-flat-gitignore'
      link: 'https://github.com/Sunny-117/eslint-config-flat-gitignore'
      desc: '.gitignore support for ESLint Flat Config'
      icon: 'i-mdi-git'
    - name: 'eslint-plugin-format'
      link: 'https://github.com/Sunny-117/eslint-plugin-format'
    ...
    - name: 'eslint-processor-vue-blocks'
      link: 'https://github.com/Sunny-117/eslint-processor-vue-blocks'
      desc: 'Create virtual files for each Vue SFC block to lint them individually.'
      icon: 'i-uim-vuejs'
    - name: 'eslint-merge-processors'
      link: 'https://github.com/Sunny-117/eslint-merge-processors'
  ...
  Productivity:
    ...
    - name: 'MultiTranslate for Raycast'
      link: 'https://github.com/Sunny-117/raycast-multi-translate'
  ...
  Design / Generative-Arts:
    ...
    - name: 'p5i'
      link: 'https://github.com/Sunny-117/p5i'
  ...
  VS Code:
    ...
    - name: 'Vite for VS Code'
      ...
      icon: 'i-carbon-flash'
    - name: 'Browse Lite'
      link: 'https://github.com/Sunny-117/vscode-browse-lite'
      desc: 'Embedded browser in VS Code'
      icon: 'i-uim-web-grid'
    - name: '文言 VS Code'
      link: 'https://github.com/Sunny-117/wenyan-lang-vscode'
      desc: '文言 Wenyan Lang for VS Code'
      icon: 'i-carbon-terminal'
    - name: 'Where am I ?'
      link: 'https://github.com/Sunny-117/vscode-where-am-i'
  ...
  Utilities:
    ...
    - name: 'qr-scanner-wechat'
      link: 'https://github.com/Sunny-117/qr-scanner-wechat'
  ...
  Configurations:
    ...
    - name: 'vscode-settings'
      link: 'https://github.com/Sunny-117/vscode-settings'
      desc: 'My VS Code settings'
      icon: 'i-simple-icons:visualstudiocode'
    - name: 'vscode-file-nesting-config'
      link: 'https://github.com/Sunny-117/vscode-file-nesting-config'
  ...
  Websites / Online Tools:
    ...
    - name: 'Prism --theme-vars'
      link: 'https://github.com/Sunny-117/prism-theme-vars'
  ...
  Windi CSS Ecosystem:
    ...
    - name: 'Windi Runtime DOM'
      link: 'https://github.com/Sunny-117/windicss-runtime-dom'
  ...
  User Scripts:
    - name: 'Refined GitHub Notification'
      link: 'https://github.com/Sunny-117/refined-github-notifications'
      desc: 'Enhances the GitHub Notifications, more productive and less noisy.'
      icon: 'i-carbon:box'
    - name: 'Clean Twitter'
      link: 'https://github.com/Sunny-117/userscript-clean-twitter'
      desc: 'Bring back the peace on Twitter'
      icon: 'i-ion-logo-twitter'

  Toys:
    - name: '1990 Script'
      link: 'https://github.com/Sunny-117/1990-script'
