    ...
    Markdown({
      ...
      async markdownItSetup(md) {
        ...
        md.use(MarkdownItMagicLink, {
          linksMap: {
            'Baidu': { link: 'https://www.baidu.com/', imageUrl: 'https://registry.npmmirror.com/@lobehub/icons-static-png/latest/files/dark/baidu-color.png' },
            'ByteDance': { link: 'https://www.bytedance.com/', imageUrl: 'https://registry.npmmirror.com/@lobehub/icons-static-png/latest/files/dark/bytedance-color.png' },
            'DiDi': { link: 'https://www.didi.com/', imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxMfIp7ASo1xBK7cQbzaFK5DIbPDappLB8aQ&s' },
            'Vitest': 'https://github.com/vitest-dev/vitest',
            'Slidev': 'https://github.com/slidevjs/slidev',
            'VueUse': 'https://github.com/vueuse/vueuse',
            'UnoCSS': 'https://github.com/unocss/unocss',
            'Elk': 'https://github.com/elk-zone/elk',
            'JS Challenges': { link: 'https://github.com/Sunny-117/js-challenges', imageUrl: 'https://github.com/Sunny-117/js-challenges/raw/main/js-challenges-logo.png' },
